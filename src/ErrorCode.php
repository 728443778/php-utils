...
define('ERROR_DATA_INVALID', 10051);
define('ERROR_USERNAME_EXISTS', 10052);
define('ERROR_ACCOUNT_IS_FREEZE', 10053);
define('ERROR_ASSET_NOT_ENOUGH', 10054);
define('ERROR_BEGIN_TRANS_FAILED', 10055);
